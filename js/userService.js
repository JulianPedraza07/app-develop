function users(page) {
    ...
    const REQRES_ENDPOINT = "https://reqres.in/api/users" + page;
...
function createUser(){
          ...
          <div class="card">
              <div class="card-body">
                  <form id="formCreateUser">
                    ...
                    <div class="row mt-3">
                      <div class="col">
                        <input type="email" class="form-control" id="email" placeholder="Email" aria-label="First name" required>
                      </div>
                      <div class="col">
                        <input type="password" class="form-control" id="password" placeholder="Password" aria-label="Last name" required>
                      </div>
                    </div>
                    <div class="row mt-3">
                      <div class="col">
                        <button type="button" class="btn btn-success" onclick="saveUser()">"Close"></button>
                      </div>
                    </div>
                  </form>
              </div>
  ...
  function saveUser(){
    ...
    .then((response) =>{
      ...
      const modal = new bootstrap.Modal.getInstance(modal)
      modal.hide()
    })
  } else {
    form.reportValidity()
